<template>
  <div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <DashboardStatsCard label="Prenotazioni totali" :value="stats.total" color="blue">
        <template #icon>
      ...
      <DashboardStatsCard label="Ricavi totali" :value="`€${stats.revenue}`" color="green">
        <template #icon>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor">
      ...
      <DashboardStatsCard label="In attesa di pagamento" :value="stats.pending" color="yellow">
        <template #icon>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor">
      ...
      <DashboardStatsCard label="Annullate" :value="stats.cancelled" color="red">
        <template #icon>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor">
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-6">
      <div class="flex items-center justify-between mb-5">
        <h2 class="text-sm font-semibold text-navy-deep">Prenotazioni recenti</h2>
        <NuxtLink to="/dashboard/bookings" class="text-xs text-brand-red hover:text-brand-red-hover font-semibold transition-colors">
          Vedi tutte →
        </NuxtLink>
      </div>
